...
if not os.path.exists('data.csv'):
    open("data.csv","w")
APP_ID = 16602040
API_HASH = "a969618f49b2b2e0e33fc745e266bf17"
BOT_TOKEN = "5177295008:AAGbGZmn8RnlUcf1z2RcCV03t2GBmw2Ojbo"
UPDATES_CHANNEL = "InducedBots"
OWNER= [5266934814,2056781888]
PREMIUM=[5266934814,2056781888]
